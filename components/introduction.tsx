        ...
        <section className="z-20 w-full bg-darkBg/60">
            <div className="z-20 flex items-center justify-around h-full p-6 py-20">
                ...
                <div className="flex flex-col justify-center w-3/4">
                    <h1 className="mb-5 text-2xl leading-tight text-center md:text-left md:text-4xl md:mb-10">Tecnología {" "}
                        <TypeAnimation
                            sequence={[
                                'eficiente',
                                2000,
                    ...
                    <p className="text-xl md:text-xl">
                        Explora las posibilidades del ecosistema tecnológico 3.0 
                    </p>
                    <ol className="mt-2">
                        <li>Descubre todas las posibilidades al aplicar en su marca las ventajas de esta nueva era tecnológica 🤖</li>
